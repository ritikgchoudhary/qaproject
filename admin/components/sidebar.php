<aside class="w-64 bg-[#0a0a0a] border-r border-white/5 h-screen fixed left-0 top-0 flex flex-col z-50">
    <div class="h-16 flex items-center px-6 border-b border-white/5">
        <div class="w-8 h-8 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg flex items-center justify-center font-black text-black mr-3 shadow-lg shadow-yellow-500/20">M</div>
        <span class="font-bold text-lg tracking-tight text-white">Master<span class="text-yellow-500">Admin</span></span>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
        ...
        <a href="wallets.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors <?= basename($_SERVER['PHP_SELF']) == 'wallets.php' ? 'bg-yellow-500/10 text-yellow-500' : 'text-gray-400 hover:text-white hover:bg-white/5' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
            Wallets
        </a>
